...
function scroll_scroll() {
	...
	let mainBlock = document.querySelector('.page__main-block');
	let mainBlockHeight = mainBlock.offsetHeight - 5;
	if (header !== null) {
		if (src_value > mainBlockHeight) {
...
//========================================================================================================================================================
if (document.querySelector(`.slider-ration__body`)) {
	new Swiper(`.slider-ration__body`, {
		observer: true,
		observeParents: true,
		autoHeight: false,
		watchOverflow: true,
...
//========================================================================================================================================================
if (document.querySelector(`.bottom-barf__body`)) {
	new Swiper(`.bottom-barf__body`, {
		observer: true,
		observeParents: true,
		autoHeight: true,
		watchOverflow: true,
